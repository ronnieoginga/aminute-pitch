...
class Config:
    ...
    SQLALCHEMY_DATABASE_URI = 'postgresql+psycopg2://moringaschool:001ronney@localhost/pitched_perfect'
    ...
    SUBJECT_PREFIX = 'ronnieogingaaminute-pitch' 
    SENDER_EMAIL = 'oginga001ronney@gmail.com'
